    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_bonuses" action="<?php echo e(route('typeContract.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">Descripción</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="descriptionType" name="descriptionType" value="<?php echo e(old('descriptionType')); ?>"
                                placeholder="Ingrese un tipo de contrato" required>
                            <?php echo $errors->first('descriptionType','<span class=error>:message</span>'); ?>
