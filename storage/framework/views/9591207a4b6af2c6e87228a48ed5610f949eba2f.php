            ...
            <div class="modal-body">
                <form id="form_bonuses" action="maritalStatus_update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameMaritalStatus_edit" name="nameMaritalStatus_edit" value="<?php echo e(old('nameMaritalStatus_edit')); ?>"
                                placeholder="Ingrese la descripción del estado civil" required>
                            <?php echo $errors->first('nameMaritalStatus_edit','<span class=error>:message</span>'); ?>
