            ...
            <div class="modal-body">
                <form id="form_bonuses" action="overtimes_update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="descriptionOvertime_edit" name="descriptionOvertime_edit" value="<?php echo e(old('descriptionOvertime_edit')); ?>"
                                placeholder="Ingrese la descripción de la hora extra" required>
                            <?php echo $errors->first('descriptionOvertime_edit','<span class=error>:message</span>'); ?>

                        </div>
                        <br><br>
                        <label for="" class="col-sm-3 col-form-label">Porcentaje</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="percent_edit" name="percent_edit" value="<?php echo e(old('percent_edit')); ?>"
                                placeholder="Ingrese el porcentaje de valor de la hora extra" step="any">
                            <?php echo $errors->first('percent_edit','<span class=error>:message</span>'); ?>
