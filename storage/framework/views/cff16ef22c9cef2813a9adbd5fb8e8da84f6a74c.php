            ...
            <div class="modal-body">
                <form id="" action="EPS_update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameEPS_edit" name="nameEPS_edit" value="<?php echo e(old('nameEPS_edit')); ?>"
                                placeholder="Ingrese el nombre de la EPS" required>
                            <?php echo $errors->first('nameEPS_edit','<span class=error>:message</span>'); ?>
