...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="form_areas" class="" action="<?php echo e(route('areas.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="txt_idareas" id="txt_idareas">
                <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label">Descripción</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nameAre" name="nameArea" value="<?php echo e(old('nameArea')); ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="bossAre" name="bossArea" value="<?php echo e(old('bossArea')); ?>"
