            ...
            <div class="modal-body">
                <form id="form_bonuses" action="rateJobs_update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameJob_edit" name="nameJob_edit" value="<?php echo e(old('nameJob_edit')); ?>"
                                placeholder="Ingrese el nombre del cargo" required>
                            <?php echo $errors->first('nameJob_edit','<span class=error>:message</span>'); ?>

                        </div>
                        <br><br>
                        <label for="" class="col-sm-3 col-form-label">Valor</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="ratesValue_edit" name="ratesValue_edit" value="<?php echo e(old('ratesValue_edit')); ?>"
                                placeholder="Ingrese el salario del cargo" required>
                            <?php echo $errors->first('ratesValue_edit','<span class=error>:message</span>'); ?>
