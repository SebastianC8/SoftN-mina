    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_areas" class="" action="{{route('areas.store')}}" method="POST">
                    @csrf
                    {{-- <input type="hidden" name="txt_areas" id="txt_areas"> --}}
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">Descripción</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameArea" name="nameArea" value="{{old('nameArea')}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="bossArea" name="bossArea" value="{{old('bossArea')}}"
