    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_bonuses" action="{{route('commissions.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameCommission" name="nameCommission" value="{{old('nameCommission')}}"
                                placeholder="Ingrese el nombre de la comisión" required>
                            {!!$errors->first('nameCommission','<span class=error>:message</span>')!!}
                        </div>
                    </div>
            </div>
