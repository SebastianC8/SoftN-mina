            ...
            <div class="modal-body">
                <form id="form_bonuses" action="deductions_update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nameDeduction_edit" name="nameDeduction_edit" value="{{old('nameDeduction_edit')}}"
                                placeholder="Ingrese una descripción de la deducción" required>
                            {!!$errors->first('nameDeduction_edit','<span class=error>:message</span>')!!}
                        </div>
                    </div>
            </div>
