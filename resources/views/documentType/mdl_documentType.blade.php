    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" action="{{route('documentType.store')}}" method="POST">
                    @csrf
                    {{-- <input type="hidden" name="txt_idDocumentType" id="txt_idDocumentType"> --}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            {!!$errors->first('descriptionDocument','<span class=error>:message</span>')!!}
                        </div>
